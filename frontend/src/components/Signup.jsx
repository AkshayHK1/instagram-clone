    ...
    return (
        <div className='flex items-center w-screen h-screen justify-center bg-gradient-to-br from-gray-50 to-gray-100'>
            <div className="w-full max-w-md">
                <form onSubmit={signupHandler} className='bg-white shadow-xl rounded-2xl flex flex-col gap-5 p-10 border border-gray-200'>
                    <div className='mb-2'>
                        <h1 className='text-center font-extrabold text-4xl mb-2'>Instagram Clone</h1>
                        <p className='text-sm text-center text-gray-500'>Sign up to see photos and videos from your friends</p>
                    </div>
